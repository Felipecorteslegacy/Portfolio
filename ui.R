...
body = dashboardBody(tags$script(HTML("$('body').addClass('fixed');")),
    tabItems(
        tabItem(tabName = "Main", h1("Portfolio Optimization", align = "center"), h2("Welcome!"), br(), h4(
            ...
            reactivity, now I will provide a couple of dynamic options that
            ...
            Stock picking"), br(), h4("
            I selected 20 assets from de Nasdaq 100 index. I took this index
            ...
            the first filter over the table, then I decided to select the top perform
            ...
            PepsiCo, Monster Beverage, Costco, Xcel Energy Inc., Exelon Corporation.", br(), h2("Author", align = "center"),
                                                                                            
                                                                                            HTML('<center><img src="Author.png" width="1000"></center>')
        ...
        tabItem(tabName = "Effi", h1("Efficient Frontier", align = "center"), 
                h4("Here you will find two efficient frontiers. I decided to separte them so
        ...
        tabItem(tabName = "Litter", h1("Black- Litterman model", align = "center"),
                ...
                h4("Showing up next, you will find 3 elements. First and below, there are the weights of the traditional
                   ...
                   Finally, in case you are interested, you will have access to the web page of investors relations of each one of the companies that I 
...
")
        ...
        tabItem(tabName = "Random", h1("Random Portfolios", align = "center"),
                ...
                h4("In this section I present every single thing related to random portfolios and its optimization.
